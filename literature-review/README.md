...
|**Gene name**|[**Protein `UniProt` ID**](https://www.uniprot.org/)|**`UniProt` Description**|Number of **References in Literature**|Previously studied under space conditions or simulation of space conditions (**space/simulation**)|Highest Differential Expression Measurement (**Fold Change**) in Literature|**Log(Fold Change)**|
|---|---|---|---|---|---|---|
